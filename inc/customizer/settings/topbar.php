...
if (!class_exists('EcStore_Top_Bar_Customizer')):

    class EcStore_Top_Bar_Customizer
    {
        ...
        {
            add_action('customize_register', array($this, 'customizer_options'), 11);
        }
        ...
        public function customizer_options($wp_customize)
        {
            ...
            $wp_customize->add_panel(
                $panel,
                array(
                    'title' => esc_html__('Top Bar', 'ecstore'),
                    'priority' => 210,
                )
            );
             ...
             */
            $wp_customize->add_setting(
                'ocean_top_bar_link_color_hover',
                array(
                    'transport' => 'postMessage',
                    'default' => '#13aff0',
                    'sanitize_callback' => 'oceanwp_sanitize_color',
            ...
            /**
             * Topbar Link Template
             */
            // settings
            $wp_customize->add_setting(
                'ecstore_top_bar_is_link',
                array(
                    'type' => 'theme_mod',
                    'default' => true,
                )
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_tablet_font_size',
                array(
                    'transport' => 'postMessage',
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_mobile_font_size',
                array(
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'oceanwp_sanitize_number_blank',
                )
             ...
             */
            $wp_customize->add_setting(
                'ocean_top_bar_social_right_padding',
                array(
                    'transport' => 'postMessage',
                    'default' => '6',
                    'sanitize_callback' => 'oceanwp_sanitize_number',
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_left_padding',
                array(
                    'transport' => 'postMessage',
                    'default' => '6',
                    'sanitize_callback' => 'oceanwp_sanitize_number',
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_tablet_right_padding',
                array(
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'oceanwp_sanitize_number_blank',
                )
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_mobile_right_padding',
                array(
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'oceanwp_sanitize_number_blank',
                )
            ...
            $wp_customize->add_setting(
                'ocean_top_bar_social_mobile_left_padding',
                array(
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'oceanwp_sanitize_number_blank',
                )
             ...
             */
            $wp_customize->add_setting(
                'ocean_top_bar_social_hover_links_color',
                array(
                    'transport' => 'postMessage',
                    'sanitize_callback' => 'oceanwp_sanitize_color',
                )
            ...
            //     $wp_customize->add_setting(
            //         'ocean_top_bar_social_profiles[' . $key . ']',
            //         array(
        ...
        public static function head_css($output)
        {
            ...
            // Top bar padding
            if (
                isset($top_padding) && '8' != $top_padding && '' != $top_padding
            ...
            if (
                isset($tablet_top_padding) && '' != $tablet_top_padding
            ...
            if (
                isset($mobile_top_padding) && '' != $mobile_top_padding
            ...
            // Top bar padding
            if (
                isset($social_right_padding) && '6' != $social_right_padding && '' != $social_right_padding
            ...
            // Tablet top bar padding
            if (
                isset($social_tablet_right_padding) && '' != $social_tablet_right_padding
            ...
            // Mobile top bar padding
            if (
                isset($social_mobile_right_padding) && '' != $social_mobile_right_padding
...
return new EcStore_Top_Bar_Customizer();