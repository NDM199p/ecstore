...
if (class_exists('WP_Customize_Control') && class_exists('WP_Customize_Section')) {
	...
	class OceanWP_Image_Checkbox_Custom_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="image_checkbox_control">
				...
				<input type="hidden" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
					value="<?php echo ow_esc_attr($this->value()); ?>" class="customize-control-multi-image-checkbox" <?php $this->link(); ?> />
				<?php foreach ($this->choices as $key => $value) { ?>
					<label class="checkbox-label">
						...
						<img src="<?php echo ow_esc_attr($value['image']); ?>" alt="<?php echo ow_esc_attr($value['name']); ?>"
							title="<?php echo ow_esc_attr($value['name']); ?>" />
					</label>
				<?php } ?>
			</div>
			<?php
				...
				<div class="radio-buttons">
					<?php foreach ($this->choices as $key => $value) { ?>
						<label class="radio-button-label">
							<input type="radio" name="<?php echo ow_esc_attr($this->id); ?>" value="<?php echo ow_esc_attr($key); ?>"
								<?php $this->link(); ?> 				<?php checked(ow_esc_attr($key), $this->value()); ?> />
							<span>
			...
			<div class="image_radio_button_control">
				...
				<?php foreach ($this->choices as $key => $value) { ?>
					...
					<label class="radio-button-label">
						...
						<img src="<?php echo esc_url($value['image']); ?>" alt="<?php echo ow_esc_attr($value['name']); ?>"
							title="<?php echo ow_esc_attr($value['name']); ?>" />
					</label>
				<?php } ?>
			</div>
		...
		public function render_content()
		{
			...
			<div class="single-accordion-custom-control">
				<div class="single-accordion-toggle">
					<?php echo esc_html($this->label); ?><span class="accordion-icon-toggle dashicons dashicons-plus"></span>
				</div>
	...
	class OceanWP_Customizer_Range_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="slider-custom-control control-wrap customize-control-oceanwp-slider">
				...
				<input type="number" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
					value="<?php echo ow_esc_attr($this->value()); ?>" class="customize-control-slider-value" <?php $this->link(); ?> />
				<div class="slider oceanwp-slider" slider-min-value="<?php echo ow_esc_attr(@$this->input_attrs['min']); ?>"
					slider-max-value="<?php echo ow_esc_attr(@$this->input_attrs['max']); ?>"
					slider-step-value="<?php echo ow_esc_attr(@$this->input_attrs['step']); ?>"></div>
			</div>
			<?php
		}
	}
		...
		public function render_content()
		{
			...
			<div class="toggle-switch-control">
				<div class="toggle-switch">
					<input type="checkbox" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
						class="toggle-switch-checkbox" value="<?php echo ow_esc_attr($this->value()); ?>" <?php
						   $this->link();
						   checked($this->value());
						   ?>>
	...
	class OceanWP_Sortable_Repeater_Custom_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="sortable_repeater_control">
				...
				<?php } ?>
				<input type="hidden" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
					value="<?php echo ow_esc_attr($this->value()); ?>" class="customize-control-sortable-repeater" <?php $this->link(); ?> />
				...
				<button class="button customize-control-sortable-repeater-add" type="button">
					<?php echo $this->button_labels['add']; ?>
				</button>
			</div>
			<?php
		}
	...
	class OceanWP_Dropdown_Select2_Custom_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="dropdown_select2_control">
				...
				<?php } ?>
				<input type="hidden" id="<?php echo ow_esc_attr($this->id); ?>" class="customize-control-dropdown-select2"
					value="<?php echo ow_esc_attr($this->value()); ?>" name="<?php echo ow_esc_attr($this->id); ?>" <?php $this->link(); ?> />
				<select name="select2-list-<?php echo ($this->multiselect ? 'multi[]' : 'single'); ?>"
					class="customize-control-select2" data-placeholder="<?php echo $this->placeholder; ?>" <?php echo ($this->multiselect ? 'multiple="multiple" ' : ''); ?>>
					<?php
					if (!$this->multiselect) {
		...
		public function render_content()
		{
			...
			if (!empty($this->fontList)) {
				...
				<div class="google_fonts_select_control">
					...
					<?php } ?>
					<input type="hidden" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
						value="<?php echo ow_esc_attr($this->value()); ?>" class="customize-control-google-font-selection" <?php $this->link(); ?> />
					...
					<div class="customize-control-description">
						<?php esc_html_e('Select weight & style for regular text', 'oceanwp'); ?>
					</div>
					...
					<div class="customize-control-description">
						<?php esc_html_e('Select weight for', 'oceanwp'); ?>
						<italic>
							<?php esc_html_e('italic text', 'oceanwp'); ?>
						</italic>
					</div>
					<div class="weight-style">
					...
					<div class="customize-control-description">
						<?php esc_html_e('Select weight for', 'oceanwp'); ?> <strong>
							<?php esc_html_e('bold text', 'oceanwp'); ?>
						</strong>
					</div>
					<div class="weight-style">
	...
	class OceanWP_Customizer_Color_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<input class="alpha-color-control" type="text" data-show-opacity="<?php echo $show_opacity; ?>"
				data-palette="<?php echo ow_esc_attr($palette); ?>"
				data-default-color="<?php echo ow_esc_attr($this->settings['default']->default); ?>" <?php $this->link(); ?> />
			<?php
		}
	}
	...
	class OceanWP_Alpha_Color_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="wpcolorpicker_alpha_color_control">
				...
				<?php } ?>
				<input type="text" class="wpcolorpicker-alpha-color-picker" id="<?php echo ow_esc_attr($this->id); ?>"
					name="<?php echo ow_esc_attr($this->id); ?>" value="<?php echo ow_esc_attr($this->value()); ?>"
	...
	class OceanWP_Customize_Multicheck_Control extends OceanWP_Custom_Control
	{
		...
		public function render_content()
		{
			...
			<div class="pill_checkbox_control">
				...
				<?php } ?>
				<input type="hidden" id="<?php echo ow_esc_attr($this->id); ?>" name="<?php echo ow_esc_attr($this->id); ?>"
					value="<?php echo ow_esc_attr($this->value()); ?>" class="customize-control-sortable-pill-checkbox" <?php $this->link(); ?> />
				<div
					class="sortable_pills<?php echo ($this->sortable ? ' sortable' : '') . ($this->fullwidth ? ' fullwidth_pills' : ''); ?>">
					<?php foreach ($reordered_choices as $key => $value) { ?>
						<label class="checkbox-label">
							<input type="checkbox" name="<?php echo ow_esc_attr($key); ?>" value="<?php echo ow_esc_attr($key); ?>"
								<?php checked(in_array(ow_esc_attr($key), $saved_choices, true), true); ?>
								class="sortable-pill-checkbox" />
							<span class="sortable-pill-title">
								<?php echo ow_esc_attr($value); ?>
							</span>
	...
	class OceanWP_Upsell_Section extends OceanWP_Custom_Section
	{
		...
		protected function render()
		{
			...
			?>
			<li id="accordion-section-<?php echo ow_esc_attr($this->id); ?>"
				class="skyrocket_upsell_section accordion-section control-section control-section-<?php echo ow_esc_attr($this->id); ?> cannot-expand">
